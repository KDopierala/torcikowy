...
function scrollFunction() {
    if (document.body.scrollTop > 80 || document.documentElement.scrollTop > 80) {
        document.getElementById("mainNav").style.padding = "5px 0 25px 0";
        document.getElementsByClassName("navbar__logo")[0].style.maxHeight = "90px";
        document.getElementById("mainNav").classList.add("navbar-shrink");
    } else {
        document.getElementById("mainNav").style.padding = "1rem 1rem";
        document.getElementsByClassName("navbar__logo")[0].style.maxHeight = "120px";
...
},{}]},["lwNxC","fgDBQ"], "fgDBQ", "parcelRequire90b8")
